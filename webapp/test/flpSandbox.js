		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#itorogelcalcinteressisoci-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"itorogelcalcinteressisoci-display": {
								"semanticObject": "itorogelcalcinteressisoci",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=it.orogel.calcinteressisoci",
									"url": sap.ui.require.toUrl("it/orogel/calcinteressisoci")
								}
							}
						}
					}
